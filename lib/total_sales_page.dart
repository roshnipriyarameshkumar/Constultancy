...
class _TotalSalesPageState extends State<TotalSalesPage> {
      ...
      case 'Week Wise':
        ...
        if (picked != null) {
          setState(() {
            ...
            // Make endDate inclusive by setting to end of day
                ...
                TextButton(
                  onPressed: () {
                    ...
                    setState(() {
                      ...
                      // Set endDate to the end of the selected end month
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Total Sales Report'), backgroundColor: Colors.indigo),
      body: Padding(
